...
const OpeningScene = () => {
    ...
    useEffect(() => {
      ...
      const showClickHere = () => {
        ...
        tl.fromTo('.enter', { scaleX: 0 }, { scaleX: 1, transformOrigin: 'center', duration: .5, delay: 10, ease: 'power1.out' });
        tl.fromTo('.enter p', { opacity: 0 }, { opacity: 0.8, duration: 1, delay: 0.5 });
